...
class TypeStructure(SQLModel, table=True):
    __tablename__ = "type_structures"
    uid: uuid.UUID = Field(
    ...
    structures: list["Structure"] = Relationship(
        back_populates="typestructure",
        sa_relationship_kwargs={
            "foreign_keys": "[Structure.type_structure_uid]" 
        }
    )