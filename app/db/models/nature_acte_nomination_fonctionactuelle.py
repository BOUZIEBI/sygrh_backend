...
class NatureActeNominationFonctionactuelle(SQLModel, table=True):
    __tablename__ = "nature_acte_nomination_fonctionactuelles"
    uid: uuid.UUID = Field(
    ...
    situation_administratives_nature_acte_nomination_dans_fonctionactuelle: Optional["SituationAdministrative"] = Relationship(
        back_populates="nature_acte_nomination_dans_fonctionactuelle",
