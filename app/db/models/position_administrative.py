...
class PositionAdministrative(SQLModel, table=True):
    __tablename__ = "position_administratives"
    uid: uuid.UUID = Field(
    ...
    situation_administratives: list["SituationAdministrative"] = Relationship(
        back_populates="position_administrative",
