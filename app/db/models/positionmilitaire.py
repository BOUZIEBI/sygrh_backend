...
class PositionMilitaire(SQLModel, table=True):
    __tablename__ = "position_militaires"
    uid: uuid.UUID = Field(
    ...
    situation_administratives_position_militaire: Optional["SituationAdministrative"] = Relationship(
        back_populates="position_militaire",
