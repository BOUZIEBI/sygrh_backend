...
class NatureActeNominationDansEmploi(SQLModel, table=True):
    __tablename__ = "nature_acte_nomination_dans_emplois"
    uid: uuid.UUID = Field(
    ...
    situation_administratives_nature_acte_nomination_dans_emploi: Optional["SituationAdministrative"] = Relationship(
        back_populates="nature_acte_nomination_dans_emploi", 
