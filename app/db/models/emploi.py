...
class Emploi(SQLModel, table=True):
    ...
    type_emploi_uid: UUID | None = Field(
        default=None,
        nullable=True,
        foreign_key="type_emplois.uid",
    )

    situation_administratives_emploi: Optional["SituationAdministrative"] = Relationship(
        back_populates="emploi",
