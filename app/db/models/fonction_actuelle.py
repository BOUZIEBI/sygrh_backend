...
class FonctionActuelle(SQLModel, table=True):
    __tablename__ = "fonction_actuelles"
    uid: uuid.UUID = Field(
    ...
    situation_administratives_fonction_actuelle: Optional["SituationAdministrative"] = Relationship(
        back_populates="fonction_actuelle",
