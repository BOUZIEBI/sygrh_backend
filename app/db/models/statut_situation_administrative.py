...
class StatutSituationAdministrative(SQLModel, table=True):
    __tablename__ = "statut_situation_administratives"
    uid: uuid.UUID = Field(
    ...
    situation_administratives_statut: Optional["SituationAdministrative"] = Relationship(
